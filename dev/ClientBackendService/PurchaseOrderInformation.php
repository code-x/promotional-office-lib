...
class PurchaseOrderInformation
{
    ...
    /**
     * @var PurchaseOrderPositionItem[] $PurchaseOrderPositions
     */
     ...
     */
    public function __construct($BuyingPriceTotal, $CurrencyFactor, $IsCanceled, $IsComplete, $IsDirectDispatch, $IsStockOrder, $OrderDate, $SupplierCreditorNumber, $WishDeliveryDate)
    {
